...
When the plugin is installed, ChatGPT or Codex connects to the selected third-party accounts through registered app integrations and, for Linear, its remote MCP endpoint. Data handling is therefore also governed by the policies of OpenAI, GitHub, Linear, Slack, and the organization that administers the connected accounts.
